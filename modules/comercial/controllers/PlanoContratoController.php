...
/**
 * PlanoContratoController implements the CRUD actions for TabAtributosValores model.
 */
class PlanoContratoController extends Controller
{

    public $id_atributo_plano=TabAtributosSearch::TIPO_CONTRATO;
    public $id_atributo_produto=TabAtributosSearch::TIPO_PRODUTO;
    /**
    ...
    {
       $searchModel = new TabAtributosValoresSearch(['fk_atributos_valores_atributos_id'=>$this->id_atributo_plano]);
        ArrayHelper::merge(
        ...
        $this->titulo = 'Gerenciar Plano/Contrato';
        $this->subTitulo = '';
    ...
    {
		$this->titulo = 'Detalhar Plano/Contrato';
		$this->subTitulo = '';
	...
	public function actionAdmin( $id = null )
	{
		...
		if ($id)
		{
			...
			$model = $this->findModel($id);
			$acao = 'update';
			$this->titulo = 'Alterar Plano/Contrato';
			$this->subTitulo = '';
		}
		else
		{
			...
			$acao = 'create';
			$model = new TabAtributosValoresSearch(['fk_atributos_valores_atributos_id'=>$this->id_atributo_plano]);

            $this->titulo = 'Incluir Plano/Contrato';
			$this->subTitulo = '';
		}
