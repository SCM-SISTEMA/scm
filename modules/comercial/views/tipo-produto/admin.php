...
if (!isset($model['fk_atributos_valores_atributos_id'])) {
    throw new yii\web\NotFoundHttpException('Página não encontrada');
}

$infoModulo = $this->context->module->info;
$fk_atributos_valores_atributos_id = $model['fk_atributos_valores_atributos_id'];
...
<div class="atributos-valores-admin">
