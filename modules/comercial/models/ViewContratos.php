...
/**
 * This is the model class for table "comercial.view_contratos".
 *
...
class ViewContratos extends \projeto\db\ActiveRecord
{
    ...
    {
        return 'comercial.view_contratos';
    }
    ...
    /**
     * @inheritdoc
     * @return ViewContratosQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ViewContratosQuery(get_called_class());
    }
}
