...
/**
 * This is the model class for table "comercial.view_cliente_contrato_all".
 *
 ...
 */
class ViewClienteContratoAll extends \projeto\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'comercial.view_cliente_contrato_all';
    }
    ...
    /**
     * @inheritdoc
     * @return ViewClienteContratoAllQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ViewClienteContratoAllQuery(get_called_class());
    }
}
