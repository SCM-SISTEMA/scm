 ...
 * @property string $situacao_sigla
 * @property string $situacao_cor
 * @property string $dsc_situacao
 */
class VisSiciCliente extends \projeto\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['dt_prazo', 'dt_vencimento', 'dt_alteracao'], 'safe'],
            [['obs_receita', 'obs_despesa', 'ordem', 'situacao_sigla', 'situacao_cor'], 'string'],
            [['cnpj'], 'string', 'max' => 18],
            [['fantasia', 'razao_social', 'dsc_situacao'], 'string', 'max' => 200],
            [['fistel'], 'string', 'max' => 15],
            [['contador', 'responsavel', 'txt_login_alteracao'], 'string', 'max' => 150],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ordem' => 'Ordem',
            'situacao_fk' => 'Situacao Fk',
            'situacao_sigla' => 'Situacao Sigla',
            'situacao_cor' => 'Situacao Cor',
            'dsc_situacao' => 'Dsc Situacao',
        ];
    }
