...
class RlcMenusPerfis extends \projeto\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['cod_perfil_fk', 'cod_menu_fk'], 'unique', 'targetAttribute' => ['cod_perfil_fk', 'cod_menu_fk'], 'message' => 'The combination of Chave estrangeira da tabela TAB_PERFIL and Chave estrangeira da tabela TAB_MENUS has already been taken.']
        ];
    }
    ...
    {
        return [
            'cod_menu_perfil' => 'Chave Primaria',
            'cod_perfil_fk' => 'Chave estrangeira da tabela TAB_PERFIL',
            'cod_menu_fk' => 'Chave estrangeira da tabela TAB_MENUS',
