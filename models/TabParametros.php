...
class TabParametros extends \projeto\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['vlr_parametro', 'dsc_parametro'], 'string'],
            [['dte_inclusao', 'dte_alteracao', 'dte_exclusao'], 'safe'],
            [['sgl_parametro'], 'string', 'max' => 50],
            [['txt_login_inclusao'], 'string', 'max' => 150],
            [['num_ano_ref', 'sgl_parametro'], 'unique', 'targetAttribute' => ['num_ano_ref', 'sgl_parametro'], 'message' => 'The combination of Num Ano Ref and Sgl Parametro has already been taken.']
        ];
    }
